        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Data Jenis UMKM</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <table class="table" id="example1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('img/backend/jenis/' . $jenis->jenis_gambar )}}" alt="homepage" class="light-logo" style="width: 10em;"></td>
                            <td>
