        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price">Rp {{$barang->barang_harga}} <del class="product-old-price">-</del></h3>
            ...
            <div class="col-md-3 col-xs-6">
                <div class="product">
                    <div class="product-img">
                        <img src="{{asset('img/backend/gambar/' . $list->barang_gambar)}}" alt="">
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-name"><a href="#">{{$list->barang_nama}}</a></h3>
                        <h4 class="product-price">Rp.{{$list->barang_harga}}</h4>
                        <div class="product-rating">
                        </div>
